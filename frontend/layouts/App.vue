...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="w-full px-5 py-3 md:py-5 text-center md:text-left flex flex-col md:flex-row items-center justify-between bg-primary-light dark:bg-primary-dark rounded-lg"
      >
