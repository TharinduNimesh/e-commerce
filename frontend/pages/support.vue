      ...
      >
        ...
        <div class="w-full md:w-1/2 flex flex-col p-10">
          ...
          <p class="text-center text-gray-600 dark:text-gray-400">
            Got questions or suggestions? Reach out through our Contact Us form.
            We value your input! Whether it's inquiries or feedback, ComicCage
            is here to listen and respond promptly. Connect with us now!
          </p>
