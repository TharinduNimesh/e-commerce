...
<template>
  <NuxtLayout name="home">
    ...
    >
      ...
      >
        <div class="px-10 lg:px-8 py-5 lg:py-0 text-center lg:text-left">
          ...
          >
            Explore a realm of digital wonders! Dive into riveting stories with
            ComicCage—your ultimate destination for downloadable comic book
            PDFs. Immerse yourself in captivating tales anytime, anywhere.
          </p>
        </div>
      </div>
      <div
    ...
    <section class="w-full mt-10 px-5 lg:px-10 py-10">
      ...
      >
        <div class="grid-col col-span-12 md:col-span-8 row-span-2 p-5 lg:p-10">
          ...
          >
            ...
            collection of downloadable comic book PDFs, unlocking a universe of
            gripping narratives and stunning visuals. Join our community, where
            each click opens the door to thrilling adventures. Convenient,
            accessible, and curated for comic enthusiasts—ComicCage, where every
            page turns into an unforgettable journey.
          </p>
        </div>
        <div
